...
**哈尔滨工业大学（深圳）**，计算机科学与技术学士，*2022年9月 - 2026年6月*
- 平均学分绩：87.303/100

**香港理工大学**，计算机科学博士，*2026年9月 - 2030年6月（预计）*
...
- **ACL 2025**（CCF A 类）：Progressive Code Acceleration Through Bidirectional Tree Editing
  - Longhui Zhang、**Jiahao Wang**、Meishan Zhang 等（二作）
  - [论文链接](https://aclanthology.org/2025.acl-long.1387)

- **ICML 2025**（CCF A 类）：Function-to-Style Guidance of LLMs for Code Translation
...
**腾讯优图实验室**，研究实习生，*2026年3月 - 至今*
- Agent Skill：通过 Agent Skill 提升端侧模型性能。
- Terminal Agent：Terminal Agent 数据合成与模型训练。

**Verilog 大语言模型技术合作项目**，研究实习生，*2025年6月 - 2026年2月*
- 华为-哈工大联合项目，CCF-华为胡杨林基金支持。
- 参与开发 Verilog 数据治理工具，蒸馏出达到业界领先水平的 Verilog 代码生成模型，并开发配套 IDE 插件。

## 开源项目

- **PyTorch-DeepLearning-Practice-Projects**：基于 PyTorch 的深度学习项目，1k+ stars
- **ZHIHUISHU-Auto-Answer-Assistant**：使用网页自动化工具和大语言模型开发的智慧树自动答题 agent
- **Douban-MovieReview-Crawler**：豆瓣评论爬虫，生成星级评分和词云

## 荣誉奖项

- 数字中国创新大赛第六名（国家级），2025年
- CCL25-Eval 任务 10 第二名（2/659），2025年
